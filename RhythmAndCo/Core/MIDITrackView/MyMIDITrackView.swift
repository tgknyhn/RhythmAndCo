// This is copied from AudioKit MIDITrackView file. I changed some of the functions here for my app
...
class NoteView: NSView {
    var viewModel: MyMIDITrackViewModel?
    var cancellable = Set<AnyCancellable>()

    func addViewModel( _ withModel: MyMIDITrackViewModel) {
...
public class MyMIDITrackViewModel: ObservableObject {
    ...
    public func play() {
        ...
        sequencer.play()
        print("interval: \(multiplier * (1/lastTempo))")
        print("tempo: \(lastTempo)")
...
public struct MyMIDITrackView: View {
    @EnvironmentObject var viewModel: MyMIDITrackViewModel
    @Binding var fileURL: URL?
    var trackNumber: Int
